          ...
          <div className="row justify-content-center">
            <div className="col-xl-3 col-lg-4 col-md-6">
              <div className="service-item style-three wow fadeInUp delay-0-2s">
                ...
                <h4>
                  <Link href="service-details">Branding and Identity</Link>
                </h4>
            ...
            <div className="col-xl-3 col-lg-4 col-md-6">
              <div className="service-item style-three wow fadeInUp delay-0-2s">
                ...
                <h4>
                  <Link href="service-details">Web Design and Development</Link>
                </h4>
                <Link href="service-details" className="more">
                  <i className="far fa-arrow-right" />
                </Link>
            ...
            <div className="col-xl-3 col-lg-4 col-md-6">
              <div className="service-item style-three wow fadeInUp delay-0-2s">
                ...
                <h4>
                  <Link href="service-details">Graphic Designing Services</Link>
                </h4>
                <Link href="service-details" className="more">
                  <i className="far fa-arrow-right" />
                </Link>
            ...
            <div className="col-lg-6">
              <div className="about-content-five">
                <div className="section-title mb-40 wow fadeInUp delay-0-2s">
                  <span className="sub-title mb-15">About ThinkAlt Media</span>
                  <h2>The World Class Creative & Marketing Agency</h2>
                </div>
                <p>
                At ThinkAlt, we believe in the power of creativity to transform businesses. We are a full-service creative and marketing agency dedicated to helping our clients stand out, connect with their audience, and achieve their goals. 
                </p>
                <div className="authors-text mt-45 pt-50">
                  ...
                  <span className="text">
                    We Have <span>100+ Global</span> Clients Around the World
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="row justify-content-center">
            <div className="col-xl-8 col-lg-10">
              <div className="section-title text-center mb-60 wow fadeInUp delay-0-2s">
                ...
                <h2>We’ve Complete 50+ Projects Take A Look Our Work</h2>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="row justify-content-center">
            <div className="col-lg-4 col-md-6">
              <div className="work-process-five wow fadeInUp delay-0-2s">
                ...
                <div className="content">
                  <p>
                  Conduct comprehensive research to understand market trends, consumer behavior, and competitor strategies. Gather valuable insights to form the foundation of your marketing and creative approach.
                  </p>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="work-process-five wow fadeInUp delay-0-4s">
                ...
                <div className="content">
                  <p>
                  Identify and segment your target audience accurately. Analyze data to understand their preferences, behaviors, and needs. Tailor your strategies to effectively engage and convert these segments.
                  </p>
                  <Link className="read-more" href="service-details">
                    Learn More <i className="far fa-arrow-right" />
                  </Link>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="work-process-five wow fadeInUp delay-0-6s">
                ...
                <div className="content">
                  <p>
                  Implement the developed strategies and monitor their performance. Measure the outcomes against predefined goals. Refine approaches based on results to continuously improve and achieve better success.
                  </p>
                  <Link className="read-more" href="service-details">
                    Learn More <i className="far fa-arrow-right" />
                  </Link>
          ...
          <div className="row no-gap">
            ...
            <div className="col-xl-7 wow fadeInUp delay-0-4s">
              ...
              >
                ...
                <p>
               Our team is ready to bring your vision to life with expert creativity and strategic marketing solutions. Let's make your ideas a reality!"
                </p>
